...
;includelib A:\\education\\2k1s\\Labs\\LP\\lab17\\Project1\\Debug\\LP_Assm01D.lib
includelib C:\\БГТУ\\ЯП\\lab_17\\123\\лаб17_арсения\\lab17\\Project1\\Debug\\LP_Assm01D.lib
extrn getmin : proc; PROTO, pArray: PTR sdword,
			 ;countOfElements: sdword

extrn getmax: proc; PROTO, pArray: PTR sdword,
			 ; countOfElements: sdword
