...
includelib C:\БГТУ\ЯП\lab_17\lab17\Project1\Debug\LP_asm01d.lib
...
.data
consolehandle dd 0h
array sdword 1 dup(1,2,3,-44,5,6,7,8,9,10)
min sdword 0
iResult sdword 0
...
mov esi, 0
mov eax, number
cdq							;Выполняет преобразование значения, находящегося в регистре eax, до размера учетверенного слова, и
							; помещает его в пару регистров edx:eах, при этом свободные биты edx заполняются знaковым битом eax.
mov ebx, 10
idiv ebx
test eax, 80000000h
jz plus
